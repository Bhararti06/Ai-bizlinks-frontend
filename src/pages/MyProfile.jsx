...
const MyProfile = () => {
    ...
    const handleFileUpload = async (e, type) => {
        ...
        formData.append('image', file); // Use 'image' to match multer.single('image')

        try {
            const endpoint = type === 'profile' ? '/users/profile-image' : '/users/company-logo'; // Fixed endpoints
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Only send personal and corporate fields, not membership fields
            const updateData = {
    ...
    const tabs = ['Personal', 'Corporate', 'Membership'];
